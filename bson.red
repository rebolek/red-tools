...
document: [s: int32 e: (print ["doc length" load-int s e]) e-list null-byte]

;e_list 	::= 	element e_list 	
;	| 	"" 	

e-list: [some [s: element e: (print ["elem:" mold copy/part s e])]] ; TODO: empty string here?
...
|	#"^(10)" (print "int32") e-name int32      ; 32-bit integer
